...
enum L10n {
    ...
    static let table: [String: (String, String)] = [
        ...
        "Update now": ("Update now", "อัปเดตเลย"),
        "update.notif.body": ("Click to download and install. Takes a few seconds; TokenBar relaunches by itself.",
                              "กดเพื่อโหลดและติดตั้ง ใช้เวลาไม่กี่วินาที TokenBar จะเปิดใหม่เอง"), "Release page": ("Release page", "หน้า release"),
